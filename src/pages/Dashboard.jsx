    ...
    >
      ...
      <div className="section">
        ...
        <div className="dash-stats">
          ...
          <StatCard icon="🎯" label="Challenges Done"    value={user?.completedChallenges?.length || 0}       color="#a78bfa" delay={200} />
          <StatCard icon="🏅" label="Badges Earned"      value={user?.badges?.length || 0}                    color="#ffd700" delay={300} />
          <StatCard icon="🔥" label="Day Streak"         value={user?.streak || 1}                            color="#ef4444" delay={400} />
          <StatCard icon="🧠" label="Quizzes Completed"  value={user?.completedQuizzes?.length || 0}          color="#f59e0b" delay={500} />
        </div>
