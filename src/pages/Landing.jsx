    ...
    <div className="landing page">
      ...
      <section className="features-section section">
        <div className="section-header">
          ...
          <h2 className="section-title">Why Students Love EcoSpark</h2>
      ...
      <section className="cta-section">
        <div className="cta-inner">
          <h2>Ready to <span className="text-gradient">Spark Change?</span></h2>
      ...
      <section className="social-section">
        <div className="social-card">
          <a href="https://instagram.com/adityagotlost" target="_blank" rel="noopener noreferrer" className="social-box">
          ...
          <a href="https://github.com/adityagotlost" target="_blank" rel="noopener noreferrer" className="social-box">
          ...
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=adityaanand3316@gmail.com" target="_blank" rel="noopener noreferrer" className="social-box">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="social-svg">
      ...
      <footer className="landing-footer">
        ...
        <div className="sdg-chips">
          <span className="chip">SDG 4: Quality Education</span>
          <span className="chip">SDG 13: Climate Action</span>
          <span className="chip">SDG 15: Life on Land</span>
        </div>
      </footer>
    </div>
  );
